...
tm1 <- system.time(
  {
    ...
    filename_bayes = paste(sub_directory, 'bayes_prob.csv', sep = '_')
    ...
    filename_mle = paste(sub_directory, 'mle_prob.csv', sep = '_')
    ...
    filename_matrix = paste(sub_directory, 'adj_matrix.csv', sep = '_')
